...
public class Menu {
	...
	//Un hashset c'est chiant pour accï¿½der aux ï¿½lï¿½ments du coup j'ai mis une list normal pour l'instant. 
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		try{
			...
			System.out.println("Connexion ï¿½ la BDD ï¿½chouï¿½e");			
		}
		...
		while(true){
			...
			while(role!=0 ){
				...
				case 1 : //Cas Stagiaire
					...
					System.out.println("[2] Se dï¿½sinscrire");	
					System.out.println("[3] Consulter la liste des activitï¿½s");
					System.out.println("[4] Visualiser les sï¿½ances planifiï¿½es");
				...
				case 2 : //Cas Responsable
					System.out.println("De quel centre ï¿½tes vous responsable?");
					getCentres();
					afficheCentres();
					uidCentre = sc.nextInt();
					System.out.println("[1] Ajouter une activitï¿½");
					System.out.println("[2] Supprimer une activitï¿½");
					System.out.println("[3] Consulter la liste des activitï¿½s");
					System.out.println("[4] Crï¿½er un groupe");
					System.out.println("[5] Supprimer un groupe");
					System.out.println("[6] Planifier une sï¿½ance pour un groupe");
					System.out.println("[7] Gï¿½rer le matï¿½riel");
					System.out.println("[8] Ajouter un moniteur");
					System.out.println("[9] Supprimer un moniteur");
					System.out.println("[20] Ajouter un stagiaire Ã  un groupe");
					System.out.println("[21] Supprimer un stagiaire d'un groupe");
				case 3: //Cas Moniteur
					System.out.println("[10] Visualiser les sï¿½ances planifiï¿½es");
					System.out.println("[11] Consulter la liste des stagiaires");
					System.out.println("[12] Classer les centres par nombre d'inscrits dans l'annï¿½e");
	...
	public static void reponseS(int reponse){
		...
		case 1: //S'inscrire
			...
			System.out.println("Numï¿½ro de rue :");
			...
			System.out.println("Date de dï¿½but du stage (jj/mm/aaaa)");
			...
			System.out.println("Activitï¿½ choisie:");
			getActivites();
			afficheActivites();
			...
			int choix;
			do{
				System.out.println("[1] Choisir une activitï¿½ supplï¿½mentaire");
				...
				if(choix==1){
					...
					activiteList.add(numActivite);
					System.out.println("Votre niveau dans cette activitï¿½\n[1]Dï¿½butant\n[2]Confirmï¿½\n[3]Expert");
			...
			break;
		case 2: //Se dï¿½sinscrire
			System.out.println("Adresse mail :");
			String mailDel = sc.next();
			desinscrireStagiaire(mailDel);
			break;
		case 3: //Consulter liste activitï¿½s
			getActivites();
			afficheActivites();
			break;
		case 4: //Visualiser sï¿½ances planifiï¿½es
			getSeances();
			afficheSeances();
			break;
		}
	...
	public static void reponseM(int reponse){
		Scanner sc = new Scanner(System.in);
		switch(reponse){
		case 10: //Visualiser sï¿½ances planifiï¿½es
			getSeances();
			afficheSeances();
			break;
		case 11: //Consulter liste stagiaires
			...
			afficheStagiaires();
			break;
		case 12: //Classer centres par nombre d'inscrits dans l'annï¿½e
			classeCentre();
			break;
	...
	public static void reponseR(int reponse){
		Scanner sc = new Scanner(System.in);
		switch(reponse){
		case 1: //Ajouter une activitï¿½
			System.out.println("Nom de l'activitï¿½ : ");
			String nom = sc.next();
			System.out.println("Catï¿½gorie de l'activitï¿½\n[1]Montagne\n[2]Nautique\n[3]Air");
			int cat = sc.nextInt();
			System.out.println("Description de l'activitï¿½ : ");
			String des = sc.next();
			System.out.println("Nombre minimum de stagiaires pour l'activitï¿½ : ");
			...
			break;
		case 2: //Supprimer une activitï¿½
			System.out.println("Indiquez l'activitï¿½ ï¿½ supprimer");
			getActivites();
			afficheActivites();
		...
		case 5: //Supprimer un groupe
			...
			supprimerGroupe(num);
			break;
		case 6: //Planifier une sï¿½ance pour un groupe
			System.out.println("Indiquez la date et l'heure de dï¿½but de la sï¿½ance (jj/mm/aaaa/h/min)");
			String naissance = sc.next();
			Date date = new Date(naissance);			
			System.out.println("Indiquez le groupe concernï¿½");
			afficherListeGroupe();
			int numGroupe = sc.nextInt();
			System.out.println("Indiquez l'activitï¿½ concernï¿½e");
			getActivites();
			afficheActivites();
			int numActivite = sc.nextInt();
			System.out.println("Indiquez la durï¿½e de la sï¿½ance (en minutes)");
			...
			do{
				System.out.println("Ajoutez un moniteur pour cette sï¿½ance (identifiï¿½ par son adresse mail)");
				afficheMoniteur();
				int numMoniteur = sc.nextInt();
				String mail = moniteurList.get(numMoniteur-1);
				seance.addMoniteur(mail);
				System.out.println("Ajouter un moniteur supplï¿½mentaire?\n[1]Oui\n[2]Non");
				plusMoniteur = sc.nextInt();
			}while(plusMoniteur == 1);
			planifierSeance(seance);
			break;
		case 7: //Gï¿½rer le matï¿½riel
			System.out.println("Quel action souhaitez-vous faire?");
			System.out.println("[1] Faire l'inventaire");
			System.out.println("[2] Ajouter du matï¿½riel");
			System.out.println("[3] Supprimer du matï¿½riel");
			System.out.println("[4] Rï¿½server du matï¿½riel");
			...
			switch(action){
				...
				case 2: //Ajouter du materiel
					int encore = 2;
					do{
						System.out.println("Ajouter du stock ï¿½ un matï¿½riel dï¿½ja existant?\n[1]Oui\n[2]Non");
						int dejaLa = sc.nextInt();
						if(dejaLa==1){
							getMateriel();
							inventaire();
							System.out.println("Indiquez le matï¿½riel concernï¿½");
							int materiel = sc.nextInt();
							System.out.println("Indiquez la quantitï¿½ ï¿½ ajouter");
							int qte = sc.nextInt();
							...
							System.out.println("Indiquez le modï¿½le");
							String modele = sc.next();
							System.out.println("Indiquez le niveau\n[1]Dï¿½butant\n[2]Confirmï¿½\n[3]Expert");
							int niveau = sc.nextInt();
							System.out.println("Indiquez la quantite de materiel ï¿½ ajouter");
							int qte = sc.nextInt();
							Materiel matos = new Materiel(type, marque, modele, niveau, qte);
							ajoutMateriel(matos);
						}
						
						System.out.println("Ajouter encore du matï¿½riel?\n[1]Oui\n[2]Non");
						encore = sc.nextInt();
					}while(encore == 1);
					
					break;
				case 3: //Supprimer du materiel
					System.out.println("Indiquez le matï¿½riel ï¿½ supprimer");
					getMateriel();
					inventaire();
				...
				case 4: //Rï¿½server du matï¿½riel
					int encore2 = 2;
					do{
						System.out.println("Indiquez le matï¿½riel ï¿½ rï¿½server");
						getMateriel();
						inventaire();
						int idMatos2 = sc.nextInt();
						System.out.println("Indiquez la quantite de ce matï¿½riel ï¿½ rï¿½server");
						int qte2 = sc.nextInt();
						...
						System.out.println("Rï¿½server encore du matï¿½riel?\n[1]Oui\n[2]Non");
						encore2 = sc.nextInt();
					}while(encore2 == 1);
		...
		case 8: //Ajouter un moniteur
			...
			String nom3 = sc.next();
			System.out.println("Prï¿½nom du moniteur");
			String prenom3 = sc.next();
			System.out.println("Adresse mail");
			String mail3 = sc.next();
			System.out.println("Tï¿½lï¿½phone");
			String tel = sc.next();
			System.out.println("Date de naissance (jj/mm/aaaa)");
			...
			int encore = 2;
			do{
				System.out.println("Indiquez l'activitï¿½ que peut encadrer le moniteur");
				getActivites();
				afficheActivites();
				int numAc2 = sc.nextInt();
				moniteur.addActivite(numAc2);
				System.out.println("Ajouter une activitï¿½ supplï¿½mentaire pour ce moniteur?\n[1]Oui\n[2]Non");
				encore = sc.nextInt();
			}while(encore == 1);
			System.out.println("Attribuez un numï¿½ro de badge ï¿½ ce moniteur");
		...
		case 9: //Supprimer un moniteur
			System.out.println("Adresse mail du moniteur ï¿½ supprimer");
			String mailDel = sc.next();
			suppressionMoniteur(mailDel);
			break;
		case 20: // Ajouter un stagiaire Ã  un groupe
			...
			int encore2 = 2;
			do{
				System.out.println("Choisissez un stagiaire Ã  insÃ©rer dans ce groupe");
				getStagiaires();
				afficheStagiaires();
				String mail = sc.next();
				//requÃªte magique
		...
		case 21: // Supprimer un stagiaire d'un groupe
			...
			int encore3 = 2;
			do{
				System.out.println("Choisissez un stagiaire Ã  supprimer de ce groupe");
				getStagiaires();
				afficheStagiaires();
				String mail = sc.next();
				//requÃªte magique
				...
				try{
					...
					if(nbStagiaire==0){
						/*Delete chaque Encadre qui contient un uidSeance liÃ© Ã  l'uidGroupe 
	...
	public static void desinscrireStagiaire(String mail){
		...
		PreparedStatement pS;
		try{
			//On rï¿½cupï¿½re tous les groupes auxquels appartient le stagiaire
			...
			for(String groupe:groupList){
				//On rï¿½cupï¿½re le nombre de stagiaire dans le groupe
				int nbDansGroupe = 0;
				...
				//On rï¿½cupï¿½re toutes les sï¿½ances auxquelles devaient assister ce groupe
				...
				while(rS2.next()){
					...
					//On rï¿½cupï¿½re le nombre minimum de stagiaire nï¿½cessaire pour l'activitï¿½ de la sï¿½ance
					...
					//Si il n'y a plus assez de stagiaire dans le groupe pour l'activitï¿½, on supprime la sï¿½ance
	...
	public static void getStagiaires(){
		...
		PreparedStatement pS;
		try{
			//On rï¿½cupï¿½re la liste des mails des stagiaires
			pS = jdbc.getConnection().prepareStatement("SELECT mail FROM Stagiaire");
			ResultSet rS = pS.executeQuery();
			while(rS.next()){
				//A partir des mails on rï¿½cupï¿½re les stagiaires
				PreparedStatement pS2 = jdbc.getConnection().prepareStatement("SELECT * FROM Personne WHERE mail = ?");
				pS2.setString(1, rS.getString(1));
				ResultSet rS2 = pS2.executeQuery();
				
				//A partir de l'uidAdresse des stagiaire on rï¿½cupï¿½re l'adresse du stagiaire
	...
	public static void supprimerGroupe(int numero){
		//faire la requete magique
		//supprimer lles sï¿½ances associï¿½s ï¿½ ce groupe + les stagiaires liï¿½s uniquement ï¿½ ce groupe
		System.out.println("\n[OK] Groupe supprimï¿½\n");
		...
		try{
			...
			while(rS.next()){
				...
				//On rï¿½cupï¿½re tous les groupes auxquels ils appartiennent
				...
				//Si le groupe que l'on supprime ï¿½tait le seul groupe du stagiaire, on le dï¿½sinscrit
				if(nbGroupe<=0){
